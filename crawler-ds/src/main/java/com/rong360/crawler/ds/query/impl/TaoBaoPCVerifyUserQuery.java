...
/**
 * 
 * @ClassName: TaoBaoPCVerifyUserQuery
 * @Description:淘宝验证PC用户名参数
 * @author xiongwei
 * @date 2015-3-20 上午11:34:06
 * 
 */
@XmlRootElement(name = "taoBaoPCVerifyUserQuery")
public class TaoBaoPCVerifyUserQuery extends Query implements Cloneable {
