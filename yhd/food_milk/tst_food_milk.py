...
def get_whole_root_page_url():
    url = 'http://www.yhd.com/ctg/s2/c5010-%E9%9D%A2%E9%83%A8%E6%8A%A4%E8%82%A4/'
...
# url = 'http://www.yhd.com/ctg/searchPage/c22886-0-59584/b/a-s1-v0-p2-price-d0-f0-m1-rt0-pid-mid0-k/'
# html = urllib2.urlopen(url).read()
# print html

whole_page_url_name = 'baby_whole_page_url'
def get_whole_page_url():
    ...
    with codecs.open(page_url_filename, mode='a', encoding='utf-8')as wf:
        count = 0
...
def read_one_page_url_get_item_id():
    # url = 'http://www.yhd.com/ctg/s2/c22882-0-59582/'
    page_url = 'http://www.yhd.com/ctg/searchVirCateAjax/vc1261/c23613/b/a-s1-v0-p1-price-d0-mid0-f0'
    html = urllib2.urlopen(page_url).read()
    if not page_url.endswith(r'f0'):
...
item_id_name = 'watchGlass_item_id'
