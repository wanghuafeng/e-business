...
def gen_whole_root_page_url():
    ...
    one_root_page_url = 'http://list.jd.com/list.html?cat=9192,9193,9201'
...
def read_one_page_url_to_get_item_id():
    url = "http://list.jd.com/list.html?cat=9192,12190,1518&page=827"
