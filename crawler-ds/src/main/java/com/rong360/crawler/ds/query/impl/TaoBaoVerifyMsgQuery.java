...
/**
 * 
 * @ClassName: TaoBaoVerifyMsgQuery
 * @Description:淘宝验证短信参数
 * @author xiongwei
 * @date 2015-3-20 上午11:34:06
 * 
 */
@XmlRootElement(name = "taoBaoVerifyMsgQuery")
public class TaoBaoVerifyMsgQuery extends Query implements Cloneable {
