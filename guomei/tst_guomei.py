...
def get_whole_root_page_url():
    url = 'http://www.gome.com.cn/category/cat10000070.html'
...
def read_one_root_url_get_pagesize():
    ...
    url_pattern = 'http://www.gome.com.cn/p/json?module=async_search&paramJson={"pageNumber":%(page_num)s,"envReq":{"catId":"%(catId)s","regionId":"11011700","ip":"119.80.62.82","cookieId":"ec6dba97-0815-4c95-8889-0208c6b46d03","et":"","XSearch":false,"pageNumber":1,"pageSize":36,"more":0,"sale":0,"instock":1,"rewriteTag":false,"priceTag":0,"promoTag":0,"question":""}}'
...
whole_page_url_name = 'digital_whole_page_url'
...
topic_name = 'book'
whole_page_url_name = '%s_whole_page_url'%topic_name
item_id_name = '%s_item_id'%topic_name
...
def read_failed_page_url():
    ...
    with codecs.open(item_id_filename, encoding='utf-8') as unique_f:
        print '%s,%s'%(item_id_name,len(unique_f.readlines()))
