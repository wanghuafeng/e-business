...
SPIDER_IN_CONFIG = 'digital'
ip_port = '122.96.59.102:83'
CONFIG_PATH = os.path.dirname(os.path.dirname(PATH))# watch item_id config directory here!
...
def write_con_into_file(con_list):
    timestamp = time.strftime('%Y_%m_%d_%H_{}'.format(SPIDER_IN_CONFIG))
