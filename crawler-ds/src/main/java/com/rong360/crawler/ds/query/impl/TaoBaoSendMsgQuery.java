...
/**
 * 
 * @ClassName: TaoBaoSendMsgQuery
 * @Description:淘宝验证发送短信参数
 * @author xiongwei
 * @date 2015-3-20 上午11:34:06
 * 
 */
@XmlRootElement(name = "taoBaoSendMsgQuery")
public class TaoBaoSendMsgQuery extends Query implements Cloneable {
