...
ROOT_URL = "http://channel.jd.com/decoration.html"


def gen_whole_topic_url():
    # url = "http://channel.jd.com/decoration.html"
...
def read_one_page_url_to_get_item_id():
    url = "http://list.jd.com/list.html?cat=9855,9862,9943&page=13"
    html = urllib2.urlopen(url).read()
    # print html
...
def get_whole_item_id():
    ITEM_FILENAME = 'decoration_item_id'
