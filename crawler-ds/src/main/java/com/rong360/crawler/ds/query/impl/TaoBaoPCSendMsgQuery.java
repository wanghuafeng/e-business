...
/**
 * 
 * @ClassName: TaoBaoPCSendMsgQuery
 * @Description:淘宝验证PC发送短信参数
 * @author xiongwei
 * @date 2015-3-20 上午11:34:06
 * 
 */
@XmlRootElement(name = "taoBaoPCSendMsgQuery")
public class TaoBaoPCSendMsgQuery extends Query implements Cloneable {
