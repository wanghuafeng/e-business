...
ROOT_URL = "http://channel.jd.com/clothing.html"
...
def read_one_page_url_to_get_pagesize():
    url = "http://list.jd.com/list.html?cat=1315,1343,1355"
...
def gen_whole_root_page_url():
    ...
    one_root_page_url = 'http://list.jd.com/list.html?cat=1315,1343,1356'
    ...
    print len(whole_root_page_url_list)
...
def read_one_page_url_to_get_item_id():
    url = "http://list.jd.com/list.html?cat=1315,1343,1355&page=27"
    ip_port = '202.108.50.75:80'
...
def get_whole_item_id():
    ITEM_FILENAME = 'clothing_item_id'
    ip_port = '202.108.50.75:80'
    http_handler = urllib2.ProxyHandler({'http':'http://%s'%ip_port})
    opener = urllib2.build_opener(http_handler)
    urllib2.install_opener(opener)
