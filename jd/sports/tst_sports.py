...
def read_one_page_url_to_get_pagesize():
    url = "http://list.jd.com/list.html?cat=1318,12099,9754"
...
def gen_whole_root_page_url():
    ...
    one_root_page_url = 'http://list.jd.com/list.html?cat=1318,12099,9754'
...
def read_one_page_url_to_get_item_id():
    url = "http://list.jd.com/list.html?cat=5025,5026,12094&page=370"
    html = urllib2.urlopen(url).read()
