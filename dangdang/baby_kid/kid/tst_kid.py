...
def get_root_page_url():
    url = 'http://category.dangdang.com/cid4004344.html'
    html = urllib2.urlopen(url).read()
    # root_url_list = re.findall(r'<span>\s*<a href="(/cid\d+\.html)#', html)
    root_url_list = re.findall(r'<a href="(/cid\d+\.html)#', html)
...
def read_one_page_url_to_get_pagesize():
    url = 'http://category.dangdang.com/cid4007241.html'
    html = urllib2.urlopen(url).read()
    # print html
