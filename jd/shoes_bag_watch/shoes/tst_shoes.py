...
def read_one_page_url_to_get_pagesize():
    url = "http://list.jd.com/list.html?cat=11729,11731,6914"
...
def gen_whole_root_page_url():
    ...
    one_root_page_url = 'http://list.jd.com/list.html?cat=11729,11731,6914'
...
def read_one_page_url_to_get_item_id():
    url = "http://list.jd.com/list.html?cat=11729,11731,12064&page=6"
    html = urllib2.urlopen(url).read()
