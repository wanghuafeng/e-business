...
def read_one_page_url_to_get_pagesize():
    url = "http://list.jd.com/list.html?cat=1319,1523,7052"
...
def gen_whole_root_page_url():
    ...
    one_root_page_url = 'http://list.jd.com/list.html?cat=1319,1523,7052'
...
def read_one_page_url_to_get_item_id():
    url = "http://list.jd.com/list.html?cat=1319,1523,7052&page=1"
